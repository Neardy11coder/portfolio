    ...
    <section className="c-space section-spacing" id="about">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          <div className="z-10">
            <p className="headtext">Hi, I'm Hardik Kapil</p>
            <p className="subtext">
             AI & Machine Learning Engineer focused on building scalable, data-driven solutions.
Experienced in ML projects, data analysis, and modern software development.
B.Tech student passionate about learning, innovation, and real-world AI applications.
📍 Deoband, India
            </p>
          </div>
        ...
        <div className="grid-black-color grid-3">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I'm based in Roorkee, India, and open to remote work worldwide.
            </p>
          </div>
        ...
        <div className="grid-default-color grid-5 relative overflow-hidden">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I work with a modern AI, ML, and software stack to build scalable,
              high-performance systems with clean and maintainable architecture.
            </p>
          </div>
